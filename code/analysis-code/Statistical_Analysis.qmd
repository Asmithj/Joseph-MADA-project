...
anova_out <- anova(model_no_interaction, model_interaction, test = "LRT")
...
# 2. Build the recipe (you already did this correctly)
...
# 4. Tune hyperparameters (optional next step)
set.seed(123)
rf_tune <- tune_grid(
  rf_workflow,
  resamples = vfold_cv(train_data, v = 10, strata = adverse_birth_outcome),
  grid = 20,  # number of hyperparameter combos
