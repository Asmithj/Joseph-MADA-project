...
# 9) Render with kable for Word, explicitly namespacing select
kable(
  table6 %>% dplyr::select(Model, Mean, SE),
  format  = "pandoc",
  digits  = 3,
  caption = "Table 6: Cross‑validated AUC (mean ± SE) for Each Model"
)
