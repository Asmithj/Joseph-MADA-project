...
#  Verify Changes
glimpse(PROMO_Data)  # More readable than str()

#  Summary of Numeric Variables
print(skim(PROMO_Data))  # Explicitly print skim output

#  Frequency Counts of Key Categorical Variables
PROMO_Data %>% count(study_arm, sort = TRUE) %>% print()
PROMO_Data %>% count(placental_malaria, sort = TRUE) %>% print()
PROMO_Data %>% count(preterm_birth_ontoneo, sort = TRUE) %>% print()
...
if (nrow(PROMO_Data) > 0) {
  ...
  # Display only the formatted table
