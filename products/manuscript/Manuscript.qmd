...
format:
  docx:
    ...
    output-dir: "products/manuscript"
...
```{r, echo=FALSE, eval=knitr::is_html_output(), message=FALSE, warning=FALSE}

library(knitr)
library(tibble)

# Create table_data as before:
table_data <- tribble(
...
# Render the table with pandoc format:
kable(table_data, format = "pandoc", caption = "Table 1. Baseline Characteristics")
