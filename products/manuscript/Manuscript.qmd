...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# Create cleaned table for Table 2
...
kable(table_preterm_pars_clean,
      caption = "",
...
# Display table with consistent styling and without row names
kable(table_stillbirth_pars,
      row.names = FALSE,
      caption = "*Table 3: Stillbirth Model*",
