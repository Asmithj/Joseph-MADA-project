...
```{r,echo=FALSE, message=FALSE, warning=FALSE}}
knitr::include_graphics("Images/Figure1.DistribTotal Malaria.png")
...
```{r}
knitr::include_graphics("Images/Table2.Outcome Measures Malaria .png")
...
```{r}
knitr::include_graphics("Images/Figure2.Differential Impact of IPTp.png")
```
