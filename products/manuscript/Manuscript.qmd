...
# 1) identify project root for here()
library(here)
here::i_am("products/manuscript/Manuscript.qmd")

# 2) tell knitr to use that root (so all relative paths start there)
library(knitr)
...
```{r fig-table1, echo=FALSE, message=FALSE, warning=FALSE}
# 2) Build the absolute, Pandoc-friendly path
table1_path <- normalizePath(
  here::here("products", "manuscript", "Images", "Table1Baseline.png"),
  winslash = "/"
)

# 3) Embed the image
knitr::include_graphics(table1_path)
```
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
# 2) Build the absolute, Pandoc-friendly path to Table4Interaction.png
table4_path <- normalizePath(
  here::here("products", "manuscript", "Images", "Table4Interaction.png"),
  winslash = "/"
)

# 3) Embed the image
knitr::include_graphics(table4_path)
```
...
```{r fig-adjusted-u25, echo=FALSE, message=FALSE, warning=FALSE}
# 2) Build a forward-slash absolute path to the image
adjusted_path <- normalizePath(
  here::here("products", "manuscript", "Images", "AdjustedRatio.png"),
  winslash = "/"
)

# 3) Embed the image
knitr::include_graphics(adjusted_path)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# 2) Build the absolute, Pandoc-friendly path to Figure 3
fig3_path <- normalizePath(
  here::here(
    "products", "manuscript", "Images",
    "Figure 3. Predicted Probability.png"
  ),
  winslash = "/"
)

# 3) Embed the image
knitr::include_graphics(fig3_path)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# 2) Build the absolute, Pandoc-friendly path to Figure 4
fig4_path <- normalizePath(
  here::here(
    "products", "manuscript", "Images",
    "Figure 4.Comparative Discriminative Performance of ML .png"
  ),
  winslash = "/"
)

# 3) Embed the image
knitr::include_graphics(fig4_path)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# 2) Build the absolute, Pandoc‐friendly path to Table 6
table6_path <- normalizePath(
  here::here(
    "products", "manuscript", "Images",
    "Table6.Discriminative Performance (AUC) of ML Models.png"
  ),
  winslash = "/"
)

# 3) Embed the image
knitr::include_graphics(table6_path)
```
