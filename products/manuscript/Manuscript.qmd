...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# Build a normalized, forward‐slash path and include the image
or_u25_path <- normalizePath(
  here::here(
    "Images",
    "Adjusted OR for Adverse Birth Outcomes Women  less 25 Years.png"
  ),
  winslash = "/"
)
knitr::include_graphics(or_u25_path)
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# Construct an absolute, forward‐slash path and include the image
fig3_path <- normalizePath(
  here::here(
    "Images",
    "Figure 3. Predicted Probability of Adverse Outcome by Gravidity Age  25.png"
  ),
  winslash = "/"
)
