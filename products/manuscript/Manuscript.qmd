...
# 1) Load here() before you call i_am()
library(here)

# 2) Tell here() where this document lives, relative to the project root.
#    (Your project root is "Joseph-MADA-project", so we point to "products/manuscript/Manuscript.qmd")
here::i_am("products/manuscript/Manuscript.qmd")

# 3) (Optional) now load knitr and set the knit root to the project root
library(knitr)
...
knitr::include_graphics(
  normalizePath(
    here::here("Images", "AdjustedRatio.png"),
    winslash = "/"
  )
)
...
knitr::include_graphics(
  normalizePath(
    here::here("Images", "Figure 3. Predicted Probability.png"),
    winslash = "/"
  )
)
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
# Build an absolute, forward‐slash path and then include the graphic
